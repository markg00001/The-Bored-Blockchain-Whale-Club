...
const GENERIC_TITLE = Bored Blockchain Whale Club; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
